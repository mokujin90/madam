                                ...
                                <tr>
                                    <td style="border-top: 1px solid #dce1e5;border-bottom: 1px solid #dce1e5;" valign="top">
                                        <p style="margin: 1em 0;">
                                            <?
                                                $license = Company2License::getCurrentLicense($request->id);
                                            ?>
                                            <?php echo CHtml::link(Yii::t('main','Ссылка'),"http://www.".Yii::app()->params['host']."/admin/Company/editLicense/id/".$license->id)?>
                                        </p>
