<div class="col-xs-12 col-lg-6">
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo $form->radioButtonList($model, 'param_imprint', array(0=>'No imprint',1=>'External website as Contacts',2=>'Maintain a custom text for Contacts' ),array('class'=>'hide-radio')); ?>
        </div>
    </div>
