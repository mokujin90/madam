<div class="col-sm-12">
    <div class="box bordered-box blue-border" style="margin-bottom:0;">
        <div class="box-header blue-background">
            <div class="title"><?=Yii::t('main','День')?> <?=Help::getDayText($date);?></div>
            <div class="actions">
                ...
                <a class="btn action-refresh btn-xs btn-link" href="#" data-date="<?=Help::getModifyDate($date, '- 1 day');?>"><i class="icon-arrow-left"></i></a>
                <a class="btn action-refresh btn-xs btn-link" href="#" data-date="<?=Help::getModifyDate($date, '+ 1 day');?>"><i class="icon-arrow-right"></i></a>
                <a class="btn action-refresh btn-xs btn-link current-date" href="#" data-date="<?=Help::getDate($date);?>"><i class="icon-refresh"></i></a>
            </div>
        </div>
        <div class="box-content box-no-padding">
            <?php $this->widget('CalendarWidget',array('user' => $user, 'mode' => 'day', 'date' => isset($date) ? $date: false)); ?>
        </div>
    </div>
</div>