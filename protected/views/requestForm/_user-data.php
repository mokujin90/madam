...
<div class="col-xs-12 col-lg-6">
    <h4><?= Yii::t('main','Данные пользователя')?></h4>
            <span>
                <?= Yii::t('main','Данные пользователя, которые заполняются при заказе термина. Email и телефон являются обязательными полями, т.к. на них осуществляется рассылка уведомлений и напоминаний.')?>
            </span>
</div>