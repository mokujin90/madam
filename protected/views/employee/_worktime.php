                                ...
                                <div class="box box-nomargin box-collapsed" style="margin-bottom:0">
                                    ...
                                    <div class="box-content">
                                        <div class="col-xs-12 clearfix">
                                            ...
                                            <div class="user-answer" style="<?if($model->isNewRecord || $scheduleRow['all_answers']==1):?>display: none;<?endif?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-xs-8">
                                                        ...
                                                        <div class="checkbox">
                                                            <label>
                                                                <?=CHtml::checkBox("schedule[$i][$scheduleUniqId][schedule2answer][$answer->id]",$model->isNewRecord || isset($tree[$answer->id][$scheduleRow['id']])?true:false)?><?=$answer->text?>
                                                            </label>
                                                        </div>
                                                        <?endforeach?>
                                                    </div>
...
<div class="col-xs-12 col-lg-4">
    <h4><?= Yii::t('main','Рабочее время')?></h4>
                        <span>
                            <?= Yii::t('main','Здесь выставляется рабочий график. Для доступа к бронированию рабочего интервала нужно отметить флажок в нужной строке. Для интервалов можно задавать условия для бронирования в блоке "доп. настройки"')?>
                        </span>
</div>