...
<ul class="nav nav-tabs" role="tablist">
    <li class="active"><a href="/#personal" role="tab" data-toggle="tab"><?= Yii::t('main','Личные данные')?></a></li>
    <li class=""><a href="/#worktime" role="tab" data-toggle="tab"><?= Yii::t('main','Рабочее время')?></a></li>
    <li><a href="/#types" role="tab" data-toggle="tab"><?= Yii::t('main','Типы назначений')?></a></li>
</ul>
...
<div class="">
    ...
    <?if (!$model->isNewRecord) {?>
        <a class="btn btn-danger remove-user" href="/employee/delete/id/<?=$model->id;?>"><?= Yii::t('main','Удалить')?></a>
    <?}?>
