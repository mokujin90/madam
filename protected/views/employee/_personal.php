<div class="col-xs-12 col-lg-6">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-2 col-sm-1">
            <div class="btn has-popover pull-right" data-content="<?= Yii::t('main',"The time frame for Appointment Manager determines at what time interval a schedule is divided at the internal representation in the Schedule Manager. Furthermore, the time scale sets the default length of an appointment, if no further information on the duration of the appointment are available. default: 30 minutes")?>" data-placement="left" data-title="<?= Yii::t('main',"Time frame for Appointment Manager:")?>" data-original-title="" title=""><i class="icon-question"></i></div>
        </div>
    </div>
    <?endif?>
    <div class="form-group">
    ...
    <div class="form-group">
        <?
            $data = User::$calendarDelimit + array('-1' => Yii::t('main','Автоматически'));
